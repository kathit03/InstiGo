...
public class CouncilEmergency extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass mainGate=new CouncilUserClass("Charusat Main Gate","Security","7349798062","",R.drawable.ritik);
        CouncilUserClass backGate=new CouncilUserClass("Charusat Back Gate","Security ","7349798063","",R.drawable.ritik);
        CouncilUserClass sportsInst1=new CouncilUserClass("Ravi Ghalimath","Sports Instructor","9482373555","",R.drawable.ritik);
        CouncilUserClass sportsInst2=new CouncilUserClass("yogesh jani","Sports Instructor","9558295583","",R.drawable.ritik);
