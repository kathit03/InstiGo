...
import com.Charusat.kathitshah.instigo.Resources.CS.CSResourceDocs;
    ...
    private void CheckSDCard(String path,String courseName,String topicName,String sub_topicName,String type) {
        if (CheckForSDCard.isSDCardPresent()) {
            ...
            if (EasyPermissions.hasPermissions(mContext, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                EasyPermissions.requestPermissions((Activity) mContext, mContext.getString(R.string.write_file), WRITE_REQUEST_CODE, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                tName=courseName;
                cName=courseName;
                sName=sub_topicName;
                docType=type;
